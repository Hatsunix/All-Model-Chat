...
const ActiveToolBadge: React.FC<{
    ...
    <>
        ...
        <div
            className="group flex items-center gap-1.5 bg-[var(--theme-bg-tertiary)] text-[var(--theme-text-link)] text-sm px-2.5 py-1 rounded-full transition-all select-none hover:bg-[var(--theme-bg-tertiary)]/80 hover:text-[var(--theme-text-primary)] cursor-pointer"
