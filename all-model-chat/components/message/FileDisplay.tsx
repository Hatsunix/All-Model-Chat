...
const CATEGORY_STYLES: Record<FileCategory, { Icon: React.ElementType, colorClass: string, bgClass: string }> = {
    image: { Icon: ImageIcon, colorClass: "text-zinc-500 dark:text-zinc-400", bgClass: "bg-zinc-500/10 dark:bg-zinc-400/10" },
    ...
    doc: { Icon: FileText, colorClass: "text-zinc-600 dark:text-zinc-500", bgClass: "bg-zinc-600/10 dark:bg-zinc-500/10" },
